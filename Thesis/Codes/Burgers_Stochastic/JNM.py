...
def Js(N):
    ...
    if (N == 6):
        ...
        N1 = 4
        J2 = J_NM(N, M, N1)
        SeqJ = np.array([1, 3] + list(range(5,7)) + [8] +  list(range(11,14)) + [15, 17])   #### This is with the numbers (N=6, M=18, N1=4),
    ...
    if (N == 7):
        ...
        N1 = 4
        J2 = J_NM(N, M, N1)
        SeqJ = np.array(list(range(1, 10)) + [11, 12, 13, 16, 18, 19, 23, 24, 25, 28, 29])  #### This is with the numbers (N=7, M=29, N1=4),
        for i in range(len(SeqJ)):
            SeqJ[i] = SeqJ[i] - 1
        M = 20
        J1 = J2[0:M, SeqJ]
    ...
    if (N == 8):
        ...
        N1 = 5
        J2 = J_NM(N, M, N1)
        SeqJ = np.array(list(range(1,10)) + [11, 12, 13, 16, 18, 19, 23, 24, 25, 28, 29, 31, 34, 35, 38, 39, 44, 48, 51, 55, 59])  #### This is with the numbers (N=7, M=29, N1=4),
        for i in range(len(SeqJ)):
            SeqJ[i] = SeqJ[i] - 1
        M = 30
        J1 = J2[0:M, SeqJ]
    ...
    if (N == 9):
        ...
        N1 = 5
        J2 = J_NM(N, M, N1)
        SeqJ = np.array(list(range(1, 10)) + [11, 12, 13, 16, 18, 19, 23, 24, 25, 28, 29, 31, 34, 35, 38, 39, 44, 48, 51, 55, 59, 63, 67, 70, 75, 81, 85, 89, 92, 95, 99])  #### This is with the numbers (N=7, M=29, N1=4),
        for i in range(len(SeqJ)):
            SeqJ[i] = SeqJ[i] - 1
        M = 40
        J1 = J2[0:M, SeqJ]
